...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 11, 2023 at 04:55 PM
...
INSERT INTO `contact_messages` (`id`, `name`, `email`, `subject`, `created_at`) VALUES
(1, 'test', 'test@ymail.com', 'dsfsdfsdf', '2023-06-11 12:46:36');
...
(13, 29, '2023-06-11', 'Completed', 'asfsafsaf', 'asfsfassfsasf', 'Clothing', 'dfdfd', NULL, NULL, 0, 'd', '2023-06-11'),
(15, 29, '2023-06-11', 'Completed', 'Facebook', 'sdfds', 'Clothing', 'video', NULL, NULL, 0, 'fffff', '2023-06-11'),
(16, 29, '2023-06-11', 'Completed', 'Facebook', 'rtry', 'Clothing', 'video', NULL, NULL, 0, 'gfg', '2023-06-11'),
(18, 29, '2023-06-11', 'Approved', 'Facebook', 'cfdfddfd', 'Clothing', 'video', NULL, NULL, 0, NULL, '2023-06-11'),
(19, 32, '2023-06-11', 'Completed', 'Facebook', 'fgfg', 'Clothing', 'video', NULL, NULL, 0, 'ssss', '2023-06-11'),
(20, 32, '2023-06-11', 'Pending', 'Facebook', 'fgf', 'Clothing', 'video', NULL, NULL, 0, NULL, '2023-06-11'),
(21, 32, '2023-06-11', 'Pending', 'Facebook', 'dfdf', 'Clothing', 'video', NULL, NULL, 5225, NULL, '2023-06-11');
...
(32, '2023-06-11', 'userd', 'user', 'user@gmail.com', '0123456789', '2023-06-01', 'male', 'assets/images/uploads/profile-pictures/default.jpg', '$2y$10$AGHT/JhfvLw5Bwtg8TzF8.YxD0uwepGj9bfUOHOB4IZj8m5r27mei', 'user');
...
--
ALTER TABLE `order_info`
  ADD CONSTRAINT `order_info_fk1` FOREIGN KEY (`s_user_id`) REFERENCES `registered_users` (`s_user_id`) ON UPDATE CASCADE,
